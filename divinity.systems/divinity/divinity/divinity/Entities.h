...
public:
	...
	bool IsPinPulled()
	{
		static int m_bPinPulled = GET_NETVAR("DT_BaseCSGrenade", "m_bPinPulled");
	...
	f_netvar(float, last_shottime, "DT_WeaponCSBase", "m_fLastShotTime");
...
public:
	...
	f_netvar(int, m_nTickBase, "DT_BasePlayer", "m_nTickBase");
	HANDLE *GetWeapons()
	{
		return (HANDLE*)((DWORD)this + 0x2DE8);
	}

	f_netvar(float, m_flDuckAmount, "DT_BasePlayer", "m_flDuckAmount");

	f_netvar(float, m_flDuckSpeed, "DT_BasePlayer", "m_flDuckSpeed");
	enum Index
	{
		GET_OBBMINS = 1,
		GET_OBBMAXS = 2,
	...
	void pre_think();
	bool physics_run_think(int smthn);
	void think();
...
//	CNETVAR_FUNC(int, team, 0xC08B6C6E); //m_iTeamNum
	...
	f_netvar(int, team, "DT_BaseEntity", "m_iTeamNum");
	...
	f_netvar(float, max_speed, "DT_BasePlayer", "m_flMaxspeed");
...
//	}
	...
	void IClientEntity::set_abs_angles_v2(const Vector & angles)
	{
		if (!this)
		return;

		static auto _set_abs_angles = (void(__thiscall*)(void*, const Vector&)) Utilities::Memory::FindPatternV2("client_panorama.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8");
	...
	void UpdateClientSideAnimation()
	{
		...
		call_vfunc<o_updateClientSideAnimation>(this, 221)(this);
	}
...
//	}
	...
	*/
	...
	void set_local_view_angles(QAngle angle) {
		using fnSetLocalViewAngles = void(__thiscall *)(void*, QAngle&);
		call_vfunc< fnSetLocalViewAngles >(this, 367)(this, angle);
	}
	...
	//	call_vfunc<OrigFn>(this, 279)(this, ret);
	//	return ret;
